...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\turtles_experiment\\turtles_categorization_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    # completed 0.0 repeats of 'training'
    ...
    for thisSize_jugment_instructions_loop in size_jugment_instructions_loop:
        ...
        routineTimer.reset()
    # completed 0.0 repeats of 'size_jugment_instructions_loop'
    ...
    # completed 0.0 repeats of 'size_judgment_trials'
