...
function exp_setupRoutineBegin(snapshot) {
  return async function () {
    ...
    exp_setupComponents.forEach( function(thisComponent) {
...
function turtle_param_functionsRoutineBegin(snapshot) {
  return async function () {
    ...
    turtle_param_functionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function categorization_instructionsLoopBegin(categorization_instructionsLoopScheduler, snapshot) {
  return async function() {
    ...
    categorization_instructions.forEach(function() {
...
function size_jugment_instructions_loopLoopBegin(size_jugment_instructions_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    size_jugment_instructions_loop.forEach(function() {
...
function size_judgment_trialsLoopBegin(size_judgment_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    size_judgment_trials.forEach(function() {
...
function transfer_standard_instructions_loopLoopBegin(transfer_standard_instructions_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    transfer_standard_instructions_loop.forEach(function() {
...
function transfer_standardLoopBegin(transfer_standardLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    transfer_standard.forEach(function() {
...
function transfer_switch_instructions_loopLoopBegin(transfer_switch_instructions_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    transfer_switch_instructions_loop.forEach(function() {
...
function transfer_switch_loopLoopBegin(transfer_switch_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    transfer_switch_loop.forEach(function() {
...
function transfer_switchLoopBegin(transfer_switchLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    transfer_switch.forEach(function() {
...
function categorization_instructions_p1RoutineBegin(snapshot) {
  return async function () {
    ...
    categorization_instructions_p1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function categorization_instructions_p2RoutineBegin(snapshot) {
  return async function () {
    ...
    categorization_instructions_p2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function categorization_instructions_p3RoutineBegin(snapshot) {
  return async function () {
    ...
    categorization_instructions_p3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function categorization_instructions_p4RoutineBegin(snapshot) {
  return async function () {
    ...
    categorization_instructions_p4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function categorization_instructions_p5RoutineBegin(snapshot) {
  return async function () {
    ...
    categorization_instructions_p5Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function categorization_instructions_p6RoutineBegin(snapshot) {
  return async function () {
    ...
    categorization_instructions_p6Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function categorization_instructions_p7RoutineBegin(snapshot) {
  return async function () {
    ...
    categorization_instructions_p7Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function categorization_instructions_p8RoutineBegin(snapshot) {
  return async function () {
    ...
    categorization_instructions_p8Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function get_turtle_params_trainingRoutineBegin(snapshot) {
  return async function () {
    ...
    get_turtle_params_trainingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function training_responseRoutineBegin(snapshot) {
  return async function () {
    ...
    training_responseComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function train_feedback_code_checksRoutineBegin(snapshot) {
  return async function () {
    ...
    train_feedback_code_checksComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function del_corr_respRoutineBegin(snapshot) {
  return async function () {
    ...
    del_corr_respComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function avg_turtle_setupRoutineBegin(snapshot) {
  return async function () {
    ...
    avg_turtle_setupComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function size_judgment_instructions_p1RoutineBegin(snapshot) {
  return async function () {
    ...
    size_judgment_instructions_p1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function size_judgment_instructions_p2RoutineBegin(snapshot) {
  return async function () {
    ...
    size_judgment_instructions_p2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function size_judgment_instructions_p3RoutineBegin(snapshot) {
  return async function () {
    ...
    size_judgment_instructions_p3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function size_judgment_instructions_p4RoutineBegin(snapshot) {
  return async function () {
    ...
    size_judgment_instructions_p4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function size_jugment_instructions_p5RoutineBegin(snapshot) {
  return async function () {
    ...
    size_jugment_instructions_p5Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function size_judgment_instructions_p6RoutineBegin(snapshot) {
  return async function () {
    ...
    size_judgment_instructions_p6Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function size_judgment_paramsRoutineBegin(snapshot) {
  return async function () {
    ...
    size_judgment_paramsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function size_judgment_responseRoutineBegin(snapshot) {
  return async function () {
    ...
    size_judgment_responseComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function size_jugment_code_checkRoutineBegin(snapshot) {
  return async function () {
    ...
    size_jugment_code_checkComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function size_judgment_feedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    size_judgment_feedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function del_corr_size_resp_tmpRoutineBegin(snapshot) {
  return async function () {
    ...
    del_corr_size_resp_tmpComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function indexRoutineBegin(snapshot) {
  return async function () {
    ...
    indexComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function transfer_loop_setupRoutineBegin(snapshot) {
  return async function () {
    ...
    transfer_loop_setupComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function transfer_standard_instructions_p1RoutineBegin(snapshot) {
  return async function () {
    ...
    transfer_standard_instructions_p1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function transfer_standard_instructions_p2RoutineBegin(snapshot) {
  return async function () {
    ...
    transfer_standard_instructions_p2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function transfer_standard_instructions_p3RoutineBegin(snapshot) {
  return async function () {
    ...
    transfer_standard_instructions_p3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function transfer_response_standardRoutineBegin(snapshot) {
  return async function () {
    ...
    transfer_response_standardComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function transfer_switch_instructions_p1RoutineBegin(snapshot) {
  return async function () {
    ...
    transfer_switch_instructions_p1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function transfer_switch_instructions_p2RoutineBegin(snapshot) {
  return async function () {
    ...
    transfer_switch_instructions_p2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function transfer_switch_instructions_p3RoutineBegin(snapshot) {
  return async function () {
    ...
    transfer_switch_instructions_p3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function transfer_switch_instructions_p4RoutineBegin(snapshot) {
  return async function () {
    ...
    transfer_switch_instructions_p4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function randomize_switch_trialsRoutineBegin(snapshot) {
  return async function () {
    ...
    randomize_switch_trialsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function transfer_response_switchRoutineBegin(snapshot) {
  return async function () {
    ...
    transfer_response_switchComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function delete_switch_orderRoutineBegin(snapshot) {
  return async function () {
    ...
    delete_switch_orderComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function begin_debriefRoutineBegin(snapshot) {
  return async function () {
    ...
    begin_debriefComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
