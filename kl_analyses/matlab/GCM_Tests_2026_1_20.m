...
% theta =   [w, c, gamma1, gamma2]
theta_0 =   [.5 1 .25 .5];       %True Parameters
theta_min = [0.01; 0.01; 0.01; 0.01];   %Minimal Values
theta_max = [1;    2;      2;    2];         %Maximal Values
...
tic
[KL_pdf3] = KL_Samp_Binom_paramSplit(model,X3,theta_0,theta_min,theta_max,grain); %External Function Call
toc
